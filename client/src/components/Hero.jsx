...
const Hero = () => {
  ...
  return (
    ...
    className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
        ...
        className='text-4xl md:text-5xl font-semibold'>Autos de Lujo en Alquiler</motion.h1>
      <motion.form 
      initial={{scale:0.95, opacity:0, y:50}}
      animate={{scale:1, opacity:1, y:0}}
      transition={{duration: 0.6, delay:0.4}}
      onSubmit={handleSearch} className='flex flex-col md:flex-row items-start md:items-center
      justify-between p-6 rounded-lg lg:rounded-full w-full max-w-80
        ...
        <div className='flex flex-col md:flex-row items-start md:items-center
         gap-10 min-md:ml-8'>
            <div className='flex flex-col items-start gap-2'>
                ...
                <p className='px-1 text-sm text-gray-500'>{pickupLocation ? pickupLocation : ' Seleccione la Localidad '}</p>
            </div>
             <div className='flex flex-col items-start gap-2'>
